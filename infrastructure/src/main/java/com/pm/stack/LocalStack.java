...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "u2ZxUk7kSd2K3lqo6N1qNnfy8XFxVxIyf8U0FSk8aGo="));
    ...
    private CfnCluster createMskCluster(){
        return CfnCluster.Builder.create(this, "MskCluster")
                ...
                .brokerNodeGroupInfo(CfnCluster.BrokerNodeGroupInfoProperty.builder()
                        ...
                        .brokerAzDistribution("DEAFULT")
                        .build())
                .build();
    }

    //Kako mikroservisite kje go najdat auth service
    ...
    private void createApiGatewayService() {
        ...
        ContainerDefinitionOptions containerOptions =
                ContainerDefinitionOptions.builder()
                        .image(ContainerImage.fromRegistry("a[pi-gateway"))
                        .environment(Map.of(
                                "SPING_PROFILES_ACTIVE", "prod",
